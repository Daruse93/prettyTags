...
class prettyTagsOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('prettytags_item_err_ns');
        }
...
return 'prettyTagsOfficeItemUpdateProcessor';
