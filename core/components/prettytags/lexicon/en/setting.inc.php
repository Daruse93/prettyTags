...
$_lang['setting_prettytags_only_isset_tag'] = 'Check for the existence of an id tag on a tag resource';
$_lang['setting_prettytags_only_isset_tag_desc'] = 'When the page is loaded, it will check if the tag exists, if not, it will lead to a 404 page';
